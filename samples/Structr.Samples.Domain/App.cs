...
namespace Structr.Samples.Domain
{
    public class App : IApp
    {
        ...
        public async Task RunAsync()
        {
            ...
            var bar1 = new Bar(Guid.NewGuid(), BarType.Cold);
            var bar2 = new Bar(Guid.NewGuid(), BarType.Warm);

            var baz1 = new Baz(BazId.Primary, "Baz1");
            var baz2 = new Baz(BazId.Secondary, "Baz2");
