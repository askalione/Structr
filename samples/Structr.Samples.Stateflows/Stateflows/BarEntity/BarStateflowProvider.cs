...
namespace Structr.Samples.Stateflows.Stateflows.BarEntity
{
    public class BarStateflowProvider : IBarStateflowProvider
    {
        ...
        public async Task<Stateflow<Bar, EBarState, EBarAction>> GetStateflowAsync(Guid entityId, CancellationToken cancellationToken)
        {
            ...
            return new Stateflow<Bar, EBarState, EBarAction>(entity, stateMachine);
        }
    }
}
