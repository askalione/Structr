...
namespace Structr.Tests.AspNetCore.Validation
{
    public class GreaterThanOrEqualToTests
    {
        ...
        {
            // Act
            var result = Test(0, 1, dependentPropertyDisplayName: "Value 2 display name");

            // Assert
            result.ErrorMessage.Should().Be("Value1 must be greater than or equal to Value 2 display name.");
        }
