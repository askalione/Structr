...
namespace Structr.AspNetCore.Referrer
{
    ...
    public static class ReferrerControllerExtensions
    {
        ...
        /// presence <see cref="ReferrerDefaults.Key"/> key in <see cref="HttpRequest.Form"/>. In case of existing of such key
        ...
        /// <param name="url">Fallback url to redirect to in case of lack of <see cref="ReferrerDefaults.Key"/> key in <see cref="HttpRequest.Form"/></param>
        ...
        /// cases use of <see cref="Referrer.ReferrerTagHelper"/> will be helpful too.</remarks>
