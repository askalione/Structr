...
Sys.Mvc.ValidatorRegistry.validators["is"] = function(rule) {
    return function (value, context) {
        ...
        var dependentProperty = AspNetCoreValidation.getId(context.fieldContext.elements[0], rule.ValidationParameters["dependentproperty"]);
...
Sys.Mvc.ValidatorRegistry.validators["requiredif"] = function (rule) {
    ...
    var operator = rule.ValidationParameters["operator"];
    return function (value, context) {
        var dependentProperty = AspNetCoreValidation.getName(context.fieldContext.elements[0], rule.ValidationParameters["dependentproperty"]);
