...
var AspNetCoreValidation = function() { };

AspNetCoreValidation.is = function (value1, operator, value2, passOnNull) {
    if (passOnNull) {
...
AspNetCoreValidation.getId = function (element, dependentPropety) {
    var pos = element.id.lastIndexOf("_") + 1;
    return element.id.substr(0, pos) + dependentPropety.replace(/\./g, "_");
};

AspNetCoreValidation.getName = function (element, dependentPropety) {
