...
{
    internal class InternalValidationAttributeAdapter : AttributeAdapterBase<ModelAwareValidationAttribute>
    {
        public InternalValidationAttributeAdapter(ModelAwareValidationAttribute attribute, IStringLocalizer stringLocalizer)
