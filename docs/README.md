...
* [Configuration](Configuration/Configuration.md)
    * [Providers](Configuration/Providers/Providers.md)
        * [JSON-file](Configuration/Providers/JsonSettingsProvider.md)
        * [XML-file](Configuration/Providers/XmlSettingsProvider.md)
        * [In-Memory](Configuration/Providers/InMemorySettingsProvider.md)
        * [Consul](Configuration/Providers/ConsulSettingsProvider.md)
